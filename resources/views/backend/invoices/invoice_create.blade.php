                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-1">
                                <div class="md-3">
                                    <label for="example-text-input">Invoice No</label>
                                    <input class="form-control" type="text" name="invoice_no" id="invoice_no" readonly
                                        style="background-color: #ddd;" value="{{ $invoice_no }}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-1">
                                <div class="md-3">
                                    <label for="example-text-input">Stock(Pic/Kg)</label>
                                    <input class="form-control" type="text" name="current_stock_qty"
...
<script id="document-template" type="text/x-handlebars-template">
    <tr class="delete_add_more_item" id="delete_add_more_item">
        ...
        <td>
            <input type="number" min="0" class="form-control selling_qty text-right" name="selling_qty[]" value="">
        </td>
    
        <td>
            <input type="number" min="0" class="form-control unit_price text-right" name="unit_price[]" value="">
        </td>

    
        <td>
            <input type="number" min="0" class="form-control selling_price  text-right" name="selling_price[]" value="0" readonly>
        </td>

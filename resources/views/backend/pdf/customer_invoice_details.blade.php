                                        ...
                                        <div class="table-responsive">
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    ...
                                                    @endphp
                                                    @foreach($payment->invoice->invoice_details as $key => $item)
                                                    <tr>
                                                        <td>{{ $key + 1 }}</td>
                                                    ...
                                                    @foreach($payment->invoice->payment_details as $payment_details)
                                                    <tr>
                                                        <td colspan="4" class="text-center" style="font-weight: bold;">
                                                            {{ date('d-m-Y', strtotime($payment_details->date)) }}</td>
                                                        <td colspan="3" class="text-center" style="font-weight: bold;">
                                                            {{ $payment_details->current_paid_amount }}</td>
                                                    </tr>
                                                    @endforeach
                                                </tbody>
                                            </table>
